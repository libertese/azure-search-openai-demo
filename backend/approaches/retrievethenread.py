...
class RetrieveThenReadApproach(Approach):
    ...
    template = \
"You are an intelligent assistant helping the city of Miranda do douro to presenver its culture that speaks Portuguese from Portugal" + \
"Use 'you' to refer to the individual asking the questions even if they ask with 'I'. " + \
"Answer the following question using only the data provided in the sources below. " + \
"For tabular information return it as an html table. Do not return markdown format. Remenber you can only talk about Miranda do douro and Dança dos Pauliteiros."  + \
